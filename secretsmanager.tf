...
resource "aws_secretsmanager_secret" "dbuser" {
  ...
  name       = "${local.secret_store_path}/${var.settings.engine_type}/${module.this.db_instance_identifier}/${local.db_name}/master_username"
  tags       = local.all_tags
}
...
resource "aws_secretsmanager_secret" "randompass" {
  depends_on = [module.this]
  name       = "${local.secret_store_path}/${var.settings.engine_type}/${module.this.db_instance_identifier}/${local.db_name}/master_password"
  tags       = local.all_tags
}
...
resource "aws_secretsmanager_secret" "rds" {
  name = "${local.secret_store_path}/${var.settings.engine_type}/${module.this.db_instance_identifier}/${local.db_name}/rds-credentials"
  tags = local.all_tags
}
